...
class MediaFile(SQLModel, table=True):
    ...
    mmif_json: Dict[str, Any] = Field(sa_column=Column(JSON))
    collections: List["Collection"] = Relationship(back_populates="media_files", link_model=MediaFileCollectionLink)
    batches: List["Batch"] = Relationship(back_populates="media_files", link_model=MediaFileBatchLink)
...
class Collection(SQLModel, table=True):
    ...
    name: str
    description: str
    media_files: List["MediaFile"] = Relationship(back_populates="collections", link_model=MediaFileCollectionLink)
...
class Batch(SQLModel, table=True):
    ...
    name: str
    description: str
    media_files: List[MediaFile] = Relationship(back_populates="batches", link_model=MediaFileBatchLink)
...
class ClamsApp(SQLModel, table=True):
    ...
    endpoint: AnyHttpUrl
    description: str
    pipelines: List["Pipeline"] = Relationship(back_populates="clams_apps", link_model=ClamsAppPipelineLink)
...
class Pipeline(SQLModel, table=True):
    ...
    name: str
    description: str
    clams_apps: List[ClamsApp] = Relationship(back_populates="pipelines", link_model=ClamsAppPipelineLink)
